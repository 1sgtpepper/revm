...
## [41.1.0](https://github.com/1sgtpepper/revm/compare/revm-database-v41.0.0...revm-database-v41.1.0) - 2026-07-06

### Added

- *(database)* add database fallback mode for BAL misses ([#3754](https://github.com/1sgtpepper/revm/pull/3754))

### Other

- *(database)* avoid double cloning in take_n_reverts ([#3539](https://github.com/1sgtpepper/revm/pull/3539))
- *(database)* use Option::filter in BundleAccount::take_info_revert ([#3730](https://github.com/1sgtpepper/revm/pull/3730))
