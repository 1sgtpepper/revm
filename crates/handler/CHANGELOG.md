...
## [42.0.0](https://github.com/1sgtpepper/revm/compare/revm-handler-v41.0.0...revm-handler-v42.0.0) - 2026-07-22

### Added

- *(amsterdam)* glam devnet-6 gas accounting & EIP alignment ([#3782](https://github.com/1sgtpepper/revm/pull/3782))
- make max refund quotient configurable ([#3757](https://github.com/1sgtpepper/revm/pull/3757))

### Fixed

- *(inspect)* finalize journal on error to prevent EIP-2929 warm set leak ([#3780](https://github.com/1sgtpepper/revm/pull/3780))
- faillible refund ([#3758](https://github.com/1sgtpepper/revm/pull/3758))

### Other

- *(revme)* separate bytecode from account in test state ([#3803](https://github.com/1sgtpepper/revm/pull/3803))
- clarify EIP-7702 regular-gas GasId names ([#3725](https://github.com/1sgtpepper/revm/pull/3725))
