...
## [41.0.1](https://github.com/1sgtpepper/revm/compare/revm-bytecode-v41.0.0...revm-bytecode-v41.0.1) - 2026-07-22

### Fixed

- *(bytecode)* avoid iterating legacy padding opcodes ([#3792](https://github.com/1sgtpepper/revm/pull/3792))

### Other

- *(deps)* bump dependencies ([#3794](https://github.com/1sgtpepper/revm/pull/3794))
- *(bytecode)* cover all truncated pushes ([#3783](https://github.com/1sgtpepper/revm/pull/3783))
