...
## [42.0.0](https://github.com/1sgtpepper/revm/compare/revm-precompile-v41.0.0...revm-precompile-v42.0.0) - 2026-07-22

### Other

- *(deps)* bump dependencies ([#3794](https://github.com/1sgtpepper/revm/pull/3794))
- *(precompile)* reduce bounds checks in precompile parsing ([#3784](https://github.com/1sgtpepper/revm/pull/3784))
